...
class transposh_mail {
	...
	public function transposh_mail_humantranslation( $translation, $original, $lang, $translated_by ) {
		...
		$body    = "<h3>" . __( 'The following translation was just added to your site',
				TRANSPOSH_TEXT_DOMAIN ) . ".</h3>\n\n"
		           ...
		           . __( 'Translated by',
				TRANSPOSH_TEXT_DOMAIN ) . ": " . transposh_utils::wordpress_user_by_by( $translated_by ) . "\n\n<br/><br/>"
		           . '<a href="' . admin_url( "admin.php?page=tp_editor" ) . '">'
		           . __( 'If you believe that those translations are not good, use the translation editor to modify it',
